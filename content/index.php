...
<html lang="en">
  ...
  <body id="landing-body">
    ...
    <main>
      <div class="title" style="background: linear-gradient( rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.3) ), url(/assets/images/clouddibal-art.webp); background-size: cover; background-position: 85%;">
